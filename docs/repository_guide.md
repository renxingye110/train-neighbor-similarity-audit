...
- `results/`
  Small JSON summaries, current-manuscript extension summaries, and file checksums for the packaged outputs.
...
- Reviewing the packaged bridge, multilabel, DeepLoc, TAPE, and simulation summaries that support the current manuscript
