...
- released-case summaries (`data/tables/supp_table_s1_released_primary_endpoint_summary.csv`)
- protocol and implementation checks (`data/tables/supp_table_s2_protocol_implementation_checks.csv`)
